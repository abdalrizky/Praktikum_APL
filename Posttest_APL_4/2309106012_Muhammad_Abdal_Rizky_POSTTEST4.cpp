...
Corporation corporations[10] = {
    {"PT Telkom Indonesia", "Telekomunikasi", {"Bandung", "Jawa Barat"}},
    {"PT Pertamina", "Energi", {"Jakarta", "DKI Jakarta"}},
    {"PT Bank Mandiri", "Perbankan", {"Jakarta", "DKI Jakarta"}},
    {"PT Bank Rakyat Indonesia", "Perbankan", {"Jakarta", "DKI Jakarta"}},
    {"PT Bank Negara Indonesia", "Perbankan", {"Jakarta", "DKI Jakarta"}},
    {"PT Bank Tabungan Negara", "Perbankan", {"Jakarta", "DKI Jakarta"}},
    {"PT Perusahaan Listrik Negara", "Energi", {"Jakarta", "DKI Jakarta"}},
};
...
void addCorporation()
{
    ...
    else
    {
        ...
        corporations[currentAmountOfCorporations].location.city = city;
        corporations[currentAmountOfCorporations].location.province = province;
